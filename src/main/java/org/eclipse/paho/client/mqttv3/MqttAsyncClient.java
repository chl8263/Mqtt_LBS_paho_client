...
public class MqttAsyncClient implements IMqttAsyncClient {
     ...
     *                                  "local://".
     * @throws IllegalArgumentException if the clientId is null or is greater than 65535 characters
     *                                  in length
     ...
     * @param executorService used for managing threads. If null then a newFixedThreadPool
     *                        is used.
     * @throws IllegalArgumentException if the URI does not start with "tcp://", "ssl://" or
     *                                  "local://"
     * @throws IllegalArgumentException if the clientId is null or is greater than 65535 characters
...
//				}
     ...
     * @param disconnectTimeout    the amount of time in milliseconds to allow send disconnect
     *                             packet to server.
    ...
    public IMqttDeliveryToken publish(String topic, MqttMessage message, Object userContext,
        ...
        comms.sendNoWait(pubMsg, token);    //여기에서 보냄

        System.out.println("딜러버리 토큰 !");
    ...
    public void lbsManager(String id, String before_gu, String before_dong, String after_gu, String after_dong) throws MqttException {
        ...
        this.lbsManager("a", message, null, null);

    }

    public IMqttDeliveryToken lbsManager(String topic, MqttMessage message, Object userContext,
                                         IMqttActionListener callback) throws MqttException, MqttPersistenceException {
        final String methodName = "publish";
        // @TRACE 111=< topic={0} message={1}userContext={1} callback={2}
        log.fine(CLASS_NAME, methodName, "111", new Object[]{topic, userContext, callback});
        ...
        // Checks if a topic is valid when publishing a message.
        //MqttTopic.validate(topic, false/* wildcards NOT allowed */);	//토픽 체크하는부분
        ...
        //MqttPublish pubMsg = new MqttPublish(topic, message);
        MqttLbsManager manager = new MqttLbsManager(topic, message);
        comms.sendNoWait(manager, token);    //여기에서 보냄

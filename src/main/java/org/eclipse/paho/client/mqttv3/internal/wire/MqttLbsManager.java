...
public class MqttLbsManager extends MqttPersistableWireMessage {
    ...
    public MqttLbsManager(String name, MqttMessage message) {
     ...
     */
    public MqttLbsManager(byte info, byte[] data) throws MqttException, IOException {
        super(MqttWireMessage.MESSAGE_TYPE_PUBLISH);
    ...
    protected byte[] getVariableHeader() throws MqttException {
        try {
            ...
            if (message.getQos() > 0) {
                ...
                dos.writeInt(20);
                //dos.writeShort(4);
                System.out.println("method in  get variable header ");
            }
            dos.flush();
